...
class Line(MyGradient):
    def __init__(self, x: int, y: int, w: int, h: int):
        ...
        self._handlePos = {"blue": [x,
                                    y + h // 2],
                           "red": [x + w//2 - self._hand_r,
                                   y + h // 2]}
        # print(self._handlePos)
...
class Repeat(MyGradient):
    def __init__(self, x: int, y: int, w: int, h: int):
        ...
        self._handlePos = {"blue": [x,
                                    y + self.height() // 2],
                           "red": [x + self.width()//2 - self._hand_r,
                                   y + self.height() // 2],
                           "r": self.width() // 2}
        self._handle = "red"  # 当前手柄
...
class Reflect(MyGradient):
    def __init__(self, x: int, y: int, w: int, h: int):
        ...
        self._handlePos = {"blue": [x,
                                    y + self.height() // 2],
                           "grey": [x + self.width()//2 - self._handle_r,
                                    y + self.height() // 2],
                           "angle": self._angle}
...
class GradientStop(MyGradient):
    def __init__(self, x: int, y: int, w: int, h: int = 50):
        ...
        # 色板对话框
        self.color_palte = PaletteFrame(shape=PaletteFrame.Rect)
...
class GradientDialog(QWidget):
    gradientChange = Signal(str)
