...
class Test(QWidget):
    def __init__(self,*args,**kwargs):
        ...
        self.qss.selector("QPushButton").updateAttr("background-color","rgb(170, 170, 0)")
        self.qss.selector("QPushButton:hover").updateAttr("background-color","rgb(170, 170, 170)")
